...
export default function WeddingPage() {
  ...
  return (
    <div className={theme === "dark" ? "bg-black text-white" : "bg-pink-50 text-gray-800"}>
      {/* BACKGROUND */}
      ...
      {/* TOP BAR */}
      <div className="flex justify-between p-4 backdrop-blur-md bg-white/40 sticky top-0 z-50">
      ...
      <section className="py-20 text-center">
        <h2 className="text-3xl font-serif mb-6">Countdown to Forever</h2>

        <div className="flex justify-center gap-6 text-2xl">
          {Object.entries(time).map(([k, v]) => (
            <div key={k} className="bg-white/60 px-4 py-3 rounded-xl shadow">
      ...
      <section className="py-20 px-6">
        <h2 className="text-3xl text-center font-serif mb-10">Gallery</h2>
      ...
      <section className="py-20 max-w-3xl mx-auto">
        <h2 className="text-3xl text-center font-serif mb-10">Our Story</h2>
