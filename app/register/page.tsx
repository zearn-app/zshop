  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute w-[400px] h-[400px] bg-purple-500 blur-3xl rounded-full"
      />
      ...
      >
        ...
        <motion.p
          ...
          className="text-purple-300 mt-2 tracking-[0.3em]"
        >
          WEDDING INVITATION
        </motion.p>
      </motion.div>
      ...
      <motion.div
        ...
        transition={{ duration: 2 }}
        className="absolute w-40 h-screen bg-white/10 blur-2xl rotate-12"
      />
    </motion.div>
  );
}
